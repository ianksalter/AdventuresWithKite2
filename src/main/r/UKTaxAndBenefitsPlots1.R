...
taxAndBenefitsDf <- taxAndBenefits2017$dataFrame(to=170001,by=1000)

# Create graph to plot income tax
ggplotBist(taxAndBenefitsDf,160000,20000,70000,10000) + 
...
ggplotBist(taxAndBenefitsDf,160000,20000,160000,20000,aes(x=initialIncome)) + 
...
ggplotBist(taxAndBenefitsDf,160000,20000,7000,1000) + 
...
ggplotBist(taxAndBenefitsDf,160000,20000,25000,5000) + 
...
taxAndBenefitsStartDf <- taxAndBenefits2017$dataFrame(to=10001,by=10)

# Create graph to plot universal credit
ggplotBist(taxAndBenefitsStartDf,8000,1000,5000,500) +
...
# Create graph to plot initial income plus earned universal credit
ggplotBist(taxAndBenefitsStartDf,8000,1000,8000,1000,aes(x=initialIncome)) +
...
#   Employees National Insurance
#   Universal Credit
ggplotBist(taxAndBenefitsDf,50000,5000,50000,5000,aes(x=initialIncome)) +
...
bistFinalIncomeSimulation1 <- sapply(taxAndBenefitsDf$initialIncome,function(income){bistIncome(income,4461.6,0.37)})
...
bistFinalIncomeSimulation2 <- sapply(taxAndBenefitsDf$initialIncome,function(income){bistIncome(income,10400,0.47)})
